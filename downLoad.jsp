...
<div id="content">
  <div id="page">
    <div id="column1">
	  ...
	  <p align="center"><span class="style5 style3 style22"> Enter The File Name </span>
	...
	String per ="",yes="";	
		  ...
		  String fname = request.getParameter("t1");
			...
			String query3="select * from vmfiles where fname='"+fname+"' "; 
	   ...
	   while ( rs3.next() )
		...
		<tr>
			...
			<td><div align="center" class="style24"><a href="downLoadd.jsp?id=<%=i%>"> <%=s1%> </a></div></td>
		</tr>
