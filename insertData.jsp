...
PreparedStatement ps=connection.prepareStatement("insert into dataowner(username,password,email,mobile,address,dob,gender,pincode,image,cloud) values(?,?,?,?,?,?,?,?,?,?)");
