  ...
  <div id="page">
    <div id="column1">
      <div class="box1">
        ...
        <p> <h2>Migrate File <span class="style22"><%=request.getParameter("fname")%></span></h2>
        </p>
        <p>
...
<%
  try 
     ...
     ResultSet rs1=st1.executeQuery(query1);
	   ...
	   if(cname.equalsIgnoreCase(cloud)==false)
	   {
          ...
          <p><form action="migrateFiles11.jsp?fname=<%=fname%>" method="post" name="form1">
  <div align="center" class="style1">  
    ...
    <table width="372" border="0">
      ...
      <tr>
        <td width="197"><div align="center" class="style8 style26 style23">Select The Cloud </div></td>
        <td width="165"><label>
