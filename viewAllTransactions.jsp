...
<div id="navigation">
  <ul>
    ...
    <li class="active"><a href="mobileterminalLogin.jsp">Mobile Terminal</a><a href="vertualMasterLogin.jsp" class="first"></a></li>
...
%>
    ...
    <div id="column2">
      <h2>Menu</h2>
      <ul>
   <li><a href="vertualMasterMain.jsp">Mobile Terminal Main</a></li>
